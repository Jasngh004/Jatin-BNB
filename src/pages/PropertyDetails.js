...
import {BiBed , BeBath , BiArea, BiBath} from 'react-icons/bi';
        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'>
          <div className='max-w-[768px]'>
            ...
            <div className='flex gap-x-6 text-violet-700 mb-6'>
              <div className='flex hap-x-2 items-center'>
          ...
          <div className='flex-1 bg-white w-full mb-8 border border border-gray-300 rounded-lg px-6 py-8'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              placeholder='Message'
              defaultValue=' Hey, i am interested in Modern apartment'></textarea>
